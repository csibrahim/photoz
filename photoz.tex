...
\begin{figure}
       \centering
         \frame{\includegraphics[trim = 30px 20px 20px 20px, clip=true,width=0.75\columnwidth]{clouds.jpg}}
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{global1.jpg}}
        \end{subfigure}
        ~
         \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VL1.jpg}}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
               \frame{ \includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VC1.jpg}}
        \end{subfigure}
       
         \begin{subfigure}[b]{0.3\columnwidth}
               \frame{ \includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{global2.jpg}}
        \end{subfigure}
        ~
         \begin{subfigure}[b]{0.3\columnwidth}
               \frame{ \includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VL2.jpg}}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VC2.jpg}}
        \end{subfigure}
       
         \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{global3.jpg}}
        \end{subfigure}
        ~
         \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VL3.jpg}}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VC3.jpg}}
        \end{subfigure}
       
         \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{global4.jpg}}
                \caption{Global length scale}
        \end{subfigure}
        ~
         \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VL4.jpg}}
                \caption{Variable length scale}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \frame{\includegraphics[trim = 160px 100px 150px 70px, clip=true,width=\textwidth]{VC4.jpg}}
...
\begin{figure}
        ...
        \begin{subfigure}[b]{0.45\columnwidth}
                \frame{\includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{ANN.jpg}}
                \caption{ANN}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.45\columnwidth}
                \frame{\includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{stableGP.jpg}}
                \caption{stableGP}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.45\columnwidth}
                \frame{\includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{GPGL.jpg}}
                \caption{GP-GL}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.45\columnwidth}
               \frame{ \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{GPVL.jpg}}
                \caption{GP-VL}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.45\columnwidth}
                \frame{\includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{GPVC.jpg}}
                \caption{GP-VC}
        \end{subfigure}
...
\begin{figure}
        \centering
        \begin{subfigure}[b]{0.3\columnwidth}
                \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{23_0.jpg}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{23_L.jpg}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{23_J.jpg}
        \end{subfigure}
        
       \begin{subfigure}[b]{0.3\columnwidth}
                \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{22_0.jpg}
                \caption{Zero mean}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
                \includegraphics[trim = 35px 15px 50px 35px, clip=true,width=\textwidth]{22_L.jpg}
                \caption{Linear}
        \end{subfigure}
        ~
        \begin{subfigure}[b]{0.3\columnwidth}
