...
\begin{figure}
        ...
        \begin{subfigure}[b]{\columnwidth}
                ...
                \label{fig-balanced}
        \end{subfigure}
       \caption{The box plots for the (a) normal sum of squared errors and (b) for the balanced cost sensitive learning for the GV-VC model when trained with $m=10$ basis functions.}
