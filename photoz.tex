...
\end{itemize}
in which $\Delta z$ is the standard Root Mean Squared Error (RMSE) and $\Delta z_\textrm{norm}$ is a normalized version that weights low redshift objects more aggressively than higher redshift objects. % The scientific requirement of {\em Euclid} is to reach a $\Delta z_\textrm{norm} \le 0.05$ \citep{laureijs2011}.
